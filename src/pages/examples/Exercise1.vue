  ...
  <q-page padding>
    <div class="form q-mb-lg">
      <div class="row q-mb-md">
        <label>Name:</label>
        <input v-model="name" :class="{ 'error' : nameIsInvalid }" v-autofocus type="text">
        <label v-show="nameIsInvalid" class="error">Please enter 15 characters or less</label>
      </div>
      <div class="row q-mb-md">
        <label>Age:</label>
        <input v-model="age" :class="{ 'error' : ageIsInvalid }" type="number">
        <label v-show="ageIsInvalid" class="error">Please enter an age between 1 - 100</label>
      </div>
      <div class="row">
